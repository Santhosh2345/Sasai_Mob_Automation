...
public class SMSNotifiers extends BasePage {
	...
	public SMSNotifiers(AndroidDriver Adriver) {
		super(Adriver);
	...
	public void setRecipient(String sNumber) {
		UtilityCustomFunctions.sendKeysNoEnter(Adriver, txtSearchReceipientNo, sNumber);
	}
	//get
	...
	public void clickDetailsTab() throws Exception {
		UtilityCustomFunctions.doClick(Adriver, tabDetails);
	}
	public String fValidateSMSNotification(String sAssignedTo,String sMobileNumber,String sSMSMsg,String sMessage,ExtentTest node) throws Exception {
		//Summary
		DetailViewPage objDVP = new DetailViewPage(Adriver); 
		UtilityCustomFunctions.doClick(Adriver, tabSummary);
		Thread.sleep(1000);
